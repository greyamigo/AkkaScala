package akka.askvtell

import akka.actor.{ActorSystem, Actor, Props, ActorRef}
import akka.askvtell.Checker.{WhiteUser, BlackUser, CheckUser}
import akka.askvtell.Recorder.NewUser
import akka.askvtell.Storage.AddUser
...
/**
 * Copied from https://github.com/SalmaKhater/Learning-Akka/blob/master/playing-with-actors/src/main/scala/TalkToActor.scala
 */
